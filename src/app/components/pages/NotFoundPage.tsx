      ...
      <main className="flex-1 bg-background flex items-center">
        <div className="max-w-[800px] mx-auto px-6 md:px-8 lg:px-12 py-20 text-center w-full">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <a
              href="/"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-amber-600 text-gray-900 rounded-lg hover:bg-amber-800 transition-all font-medium shadow-md hover:shadow-lg"
            >
